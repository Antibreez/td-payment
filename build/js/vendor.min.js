 ...
 */
function(e){var t,i,a,n,r,o,s,l=navigator.userAgent;e.HTMLPictureElement&&/ecko/.test(l)&&l.match(/rv\:(\d+)/)&&RegExp.$1<45&&addEventListener("resize",(i=document.createElement("source"),a=function(e){var t,a,n=e.parentNode;"PICTURE"===n.nodeName.toUpperCase()?(t=i.cloneNode(),n.insertBefore(t,n.firstElementChild),setTimeout((function(){n.removeChild(t)}))):(!e._pfLastSize||e.offsetWidth>e._pfLastSize)&&(e._pfLastSize=e.offsetWidth,a=e.sizes,e.sizes+=",100vw",setTimeout((function(){e.sizes=a})))},n=function(){var e,t=document.querySelectorAll("picture > img, img[srcset][sizes]");for(e=0;e<t.length;e++)a(t[e])},r=function(){clearTimeout(t),t=setTimeout(n,99)},o=e.matchMedia&&matchMedia("(orientation: landscape)"),s=function(){r(),o&&o.addListener&&o.addListener(r)},i.srcset="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",/^[c|i]|d$/.test(document.readyState||"")?s():document.addEventListener("DOMContentLoaded",s),r))}(window),
/*! Picturefill - v3.0.2
 * http://scottjehl.github.io/picturefill
 * Copyright (c) 2015 https://github.com/scottjehl/picturefill/blob/master/Authors.txt;
 *  License: MIT
 */
function(e,t,i){"use strict";var a,n,r;t.createElement("picture");var o={},s=!1,l=function(){},c=t.createElement("img"),u=c.getAttribute,f=c.setAttribute,d=c.removeAttribute,p=t.documentElement,h={},m={algorithm:""},v="data-pfsrc",g=v+"set",k=navigator.userAgent,y=/rident/.test(k)||/ecko/.test(k)&&k.match(/rv\:(\d+)/)&&RegExp.$1>35,b="currentSrc",x=/\s+\+?\d+(e\d+)?w/,_=/(\([^)]+\))?\s*(.+)/,P=e.picturefillCFG,E="font-size:100%!important;",w=!0,S={},A={},M=e.devicePixelRatio,T={px:1,in:96},O=t.createElement("a"),C=!1,D=/^[ \t\n\r\u000c]+/,B=/^[, \t\n\r\u000c]+/,R=/^[^ \t\n\r\u000c]+/,j=/[,]+$/,L=/^\d+$/,I=/^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/,F=function(e,t,i,a){e.addEventListener?e.addEventListener(t,i,a||!1):e.attachEvent&&e.attachEvent("on"+t,i)},N=function(e){var t={};return function(i){return i in t||(t[i]=e(i)),t[i]}};function V(e){return" "===e||"\t"===e||"\n"===e||"\f"===e||"\r"===e}var G,H,z,U,K,q,$,Q,W,J,Y,Z,X,ee,te,ie,ae=(G=/^([\d\.]+)(em|vw|px)$/,H=N((function(e){return"return "+function(){for(var e=arguments,t=0,i=e[0];++t in e;)i=i.replace(e[t],e[++t]);return i}((e||"").toLowerCase(),/\band\b/g,"&&",/,/g,"||",/min-([a-z-\s]+):/g,"e.$1>=",/max-([a-z-\s]+):/g,"e.$1<=",/calc([^)]+)/g,"($1)",/(\d+[\.]*[\d]*)([a-z]+)/g,"($1 * e.$2)",/^(?!(e.[a-z]|[0-9\.&=|><\+\-\*\(\)\/])).*/gi,"")+";"})),function(e,t){var i;if(!(e in S))if(S[e]=!1,t&&(i=e.match(G)))S[e]=i[1]*T[i[2]];else try{S[e]=new Function("e",H(e))(T)}catch(e){}return S[e]}),ne=function(e,t){return e.w?(e.cWidth=o.calcListLength(t||"100vw"),e.res=e.w/e.cWidth):e.res=e.d,e},re=function(e){if(s){var i,a,n,r=e||{};if(r.elements&&1===r.elements.nodeType&&("IMG"===r.elements.nodeName.toUpperCase()?r.elements=[r.elements]:(r.context=r.elements,r.elements=null)),n=(i=r.elements||o.qsa(r.context||t,r.reevaluate||r.reselect?o.sel:o.selShort)).length){for(o.setupRun(r),C=!0,a=0;a<n;a++)o.fillImg(i[a],r);o.teardownRun(r)}}};function oe(e,t){return e.res-t.res}function se(e,t){var i,a,n;if(e&&t)for(n=o.parseSet(t),e=o.makeUrl(e),i=0;i<n.length;i++)if(e===o.makeUrl(n[i].url)){a=n[i];break}return a}e.console&&console.warn,b in c||(b="src"),h["image/jpeg"]=!0,h["image/gif"]=!0,h["image/png"]=!0,h["image/svg+xml"]=t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1"),o.ns=("pf"+(new Date).getTime()).substr(0,9),o.supSrcset="srcset"in c,o.supSizes="sizes"in c,o.supPicture=!!e.HTMLPictureElement,o.supSrcset&&o.supPicture&&!o.supSizes&&(z=t.createElement("img"),c.srcset="data:,a",z.src="data:,a",o.supSrcset=c.complete===z.complete,o.supPicture=o.supSrcset&&o.supPicture),o.supSrcset&&!o.supSizes?(U="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",K=t.createElement("img"),q=function(){2===K.width&&(o.supSizes=!0),n=o.supSrcset&&!o.supSizes,s=!0,setTimeout(re)},K.onload=q,K.onerror=q,K.setAttribute("sizes","9px"),K.srcset=U+" 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 9w",K.src=U):s=!0,o.selShort="picture>img,img[srcset]",o.sel=o.selShort,o.cfg=m,o.DPR=M||1,o.u=T,o.types=h,o.setSize=l,o.makeUrl=N((function(e){return O.href=e,O.href})),o.qsa=function(e,t){return"querySelector"in e?e.querySelectorAll(t):[]},o.matchesMedia=function(){return e.matchMedia&&(matchMedia("(min-width: 0.1em)")||{}).matches?o.matchesMedia=function(e){return!e||matchMedia(e).matches}:o.matchesMedia=o.mMQ,o.matchesMedia.apply(this,arguments)},o.mMQ=function(e){return!e||ae(e)},o.calcLength=function(e){var t=ae(e,!0)||!1;return t<0&&(t=!1),t},o.supportsType=function(e){return!e||h[e]},o.parseSize=N((function(e){var t=(e||"").match(_);return{media:t&&t[1],length:t&&t[2]}})),o.parseSet=function(e){return e.cands||(e.cands=function(e,t){function i(t){var i,a=t.exec(e.substring(c));if(a)return i=a[0],c+=i.length,i}var a,n,r,o,s,l=e.length,c=0,u=[];function f(){var e,i,r,o,s,l,c,f,d,p=!1,h={};for(o=0;o<n.length;o++)l=(s=n[o])[s.length-1],c=s.substring(0,s.length-1),f=parseInt(c,10),d=parseFloat(c),L.test(c)&&"w"===l?((e||i)&&(p=!0),0===f?p=!0:e=f):I.test(c)&&"x"===l?((e||i||r)&&(p=!0),d<0?p=!0:i=d):L.test(c)&&"h"===l?((r||i)&&(p=!0),0===f?p=!0:r=f):p=!0;p||(h.url=a,e&&(h.w=e),i&&(h.d=i),r&&(h.h=r),r||i||e||(h.d=1),1===h.d&&(t.has1x=!0),h.set=t,u.push(h))}function d(){for(i(D),r="",o="in descriptor";;){if(s=e.charAt(c),"in descriptor"===o)if(V(s))r&&(n.push(r),r="",o="after descriptor");else{if(","===s)return c+=1,r&&n.push(r),void f();if("("===s)r+=s,o="in parens";else{if(""===s)return r&&n.push(r),void f();r+=s}}else if("in parens"===o)if(")"===s)r+=s,o="in descriptor";else{if(""===s)return n.push(r),void f();r+=s}else if("after descriptor"===o)if(V(s));else{if(""===s)return void f();o="in descriptor",c-=1}c+=1}}for(;;){if(i(B),c>=l)return u;a=i(R),n=[],","===a.slice(-1)?(a=a.replace(j,""),f()):d()}}(e.srcset,e)),e.cands},o.getEmValue=function(){var e;if(!a&&(e=t.body)){var i=t.createElement("div"),n=p.style.cssText,r=e.style.cssText;i.style.cssText="position:absolute;left:0;visibility:hidden;display:block;padding:0;border:none;font-size:1em;width:1em;overflow:hidden;clip:rect(0px, 0px, 0px, 0px)",p.style.cssText=E,e.style.cssText=E,e.appendChild(i),a=i.offsetWidth,e.removeChild(i),a=parseFloat(a,10),p.style.cssText=n,e.style.cssText=r}return a||16},o.calcListLength=function(e){if(!(e in A)||m.uT){var t=o.calcLength(function(e){var t,i,a,n,r,s,l,c=/^(?:[+-]?[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?(?:ch|cm|em|ex|in|mm|pc|pt|px|rem|vh|vmin|vmax|vw)$/i,u=/^calc\((?:[0-9a-z \.\+\-\*\/\(\)]+)\)$/i;for(a=(i=function(e){var t,i="",a=[],n=[],r=0,o=0,s=!1;function l(){i&&(a.push(i),i="")}function c(){a[0]&&(n.push(a),a=[])}for(;;){if(""===(t=e.charAt(o)))return l(),c(),n;if(s){if("*"===t&&"/"===e[o+1]){s=!1,o+=2,l();continue}o+=1}else{if(V(t)){if(e.charAt(o-1)&&V(e.charAt(o-1))||!i){o+=1;continue}if(0===r){l(),o+=1;continue}t=" "}else if("("===t)r+=1;else if(")"===t)r-=1;else{if(","===t){l(),c(),o+=1;continue}if("/"===t&&"*"===e.charAt(o+1)){s=!0,o+=2;continue}}i+=t,o+=1}}}(e)).length,t=0;t<a;t++)if(r=(n=i[t])[n.length-1],l=r,c.test(l)&&parseFloat(l)>=0||u.test(l)||"0"===l||"-0"===l||"+0"===l){if(s=r,n.pop(),0===n.length)return s;if(n=n.join(" "),o.matchesMedia(n))return s}return"100vw"}(e));A[e]=t||T.width}return A[e]},o.setRes=function(e){var t;if(e)for(var i=0,a=(t=o.parseSet(e)).length;i<a;i++)ne(t[i],e.sizes);return t},o.setRes.res=ne,o.applySetCandidate=function(e,t){if(e.length){var i,a,n,r,s,l,c,u,f,d,p,h,v,g,k,x,_=t[o.ns],P=o.DPR;if(l=_.curSrc||t[b],(c=_.curCan||function(e,t,i){var a;return!i&&t&&(i=(i=e[o.ns].sets)&&i[i.length-1]),(a=se(t,i))&&(t=o.makeUrl(t),e[o.ns].curSrc=t,e[o.ns].curCan=a,a.res||ne(a,a.set.sizes)),a}(t,l,e[0].set))&&c.set===e[0].set&&((f=y&&!t.complete&&c.res-.1>P)||(c.cached=!0,c.res>=P&&(s=c))),!s)for(e.sort(oe),s=e[(r=e.length)-1],a=0;a<r;a++)if((i=e[a]).res>=P){s=e[n=a-1]&&(f||l!==o.makeUrl(i.url))&&(d=e[n].res,p=i.res,h=P,v=e[n].cached,g=void 0,k=void 0,x=void 0,"saveData"===m.algorithm?d>2.7?x=h+1:(k=(p-h)*(g=Math.pow(d-.6,1.5)),v&&(k+=.1*g),x=d+k):x=h>1?Math.sqrt(d*p):d,x>h)?e[n]:i;break}s&&(u=o.makeUrl(s.url),_.curSrc=u,_.curCan=s,u!==l&&o.setSrc(t,s),o.setSize(t))}},o.setSrc=function(e,t){var i;e.src=t.url,"image/svg+xml"===t.set.type&&(i=e.style.width,e.style.width=e.offsetWidth+1+"px",e.offsetWidth+1&&(e.style.width=i))},o.getSet=function(e){var t,i,a,n=!1,r=e[o.ns].sets;for(t=0;t<r.length&&!n;t++)if((i=r[t]).srcset&&o.matchesMedia(i.media)&&(a=o.supportsType(i.type))){"pending"===a&&(i=a),n=i;break}return n},o.parseSets=function(e,t,a){var r,s,l,c,p=t&&"PICTURE"===t.nodeName.toUpperCase(),h=e[o.ns];(h.src===i||a.src)&&(h.src=u.call(e,"src"),h.src?f.call(e,v,h.src):d.call(e,v)),(h.srcset===i||a.srcset||!o.supSrcset||e.srcset)&&(r=u.call(e,"srcset"),h.srcset=r,c=!0),h.sets=[],p&&(h.pic=!0,function(e,t){var i,a,n,r,s=e.getElementsByTagName("source");for(i=0,a=s.length;i<a;i++)(n=s[i])[o.ns]=!0,(r=n.getAttribute("srcset"))&&t.push({srcset:r,media:n.getAttribute("media"),type:n.getAttribute("type"),sizes:n.getAttribute("sizes")})}(t,h.sets)),h.srcset?(s={srcset:h.srcset,sizes:u.call(e,"sizes")},h.sets.push(s),(l=(n||h.src)&&x.test(h.srcset||""))||!h.src||se(h.src,s)||s.has1x||(s.srcset+=", "+h.src,s.cands.push({url:h.src,d:1,set:s}))):h.src&&h.sets.push({srcset:h.src,sizes:null}),h.curCan=null,h.curSrc=i,h.supported=!(p||s&&!o.supSrcset||l&&!o.supSizes),c&&o.supSrcset&&!h.supported&&(r?(f.call(e,g,r),e.srcset=""):d.call(e,g)),h.supported&&!h.srcset&&(!h.src&&e.src||e.src!==o.makeUrl(h.src))&&(null===h.src?e.removeAttribute("src"):e.src=h.src),h.parsed=!0},o.fillImg=function(e,t){var i,a=t.reselect||t.reevaluate;e[o.ns]||(e[o.ns]={}),i=e[o.ns],(a||i.evaled!==r)&&(i.parsed&&!t.reevaluate||o.parseSets(e,e.parentNode,t),i.supported?i.evaled=r:function(e){var t,i=o.getSet(e),a=!1;"pending"!==i&&(a=r,i&&(t=o.setRes(i),o.applySetCandidate(t,e))),e[o.ns].evaled=a}(e))},o.setupRun=function(){C&&!w&&M===e.devicePixelRatio||(w=!1,M=e.devicePixelRatio,S={},A={},o.DPR=M||1,T.width=Math.max(e.innerWidth||0,p.clientWidth),T.height=Math.max(e.innerHeight||0,p.clientHeight),T.vw=T.width/100,T.vh=T.height/100,r=[T.height,T.width,M].join("-"),T.em=o.getEmValue(),T.rem=T.em)},o.supPicture?(re=l,o.fillImg=l):(X=e.attachEvent?/d$|^c/:/d$|^c|^i/,ee=function(){var e=t.readyState||"";te=setTimeout(ee,"loading"===e?200:999),t.body&&(o.fillImgs(),($=$||X.test(e))&&clearTimeout(te))},te=setTimeout(ee,t.body?9:99),ie=p.clientHeight,F(e,"resize",(Q=function(){w=Math.max(e.innerWidth||0,p.clientWidth)!==T.width||p.clientHeight!==ie,ie=p.clientHeight,w&&o.fillImgs()},W=99,Z=function(){var e=new Date-Y;e<W?J=setTimeout(Z,W-e):(J=null,Q())},function(){Y=new Date,J||(J=setTimeout(Z,W))})),F(t,"readystatechange",ee)),o.picturefill=re,o.fillImgs=re,o.teardownRun=l,re._=o,e.picturefillCFG={pf:o,push:function(e){var t=e.shift();"function"==typeof o[t]?o[t].apply(o,e):(m[t]=e[0],C&&o.fillImgs({reselect:!0}))}};for(;P&&P.length;)e.picturefillCFG.push(P.shift());e.picturefill=re,"object"==typeof module&&"object"==typeof module.exports?module.exports=re:"function"==typeof define&&define.amd&&define("picturefill",(function(){return re})),o.supPicture||(h["image/webp"]=function(t,i){var a=new e.Image;return a.onerror=function(){h[t]=!1,re()},a.onload=function(){h[t]=1===a.width,re()},a.src=i,"pending"}("image/webp","data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA=="))}(window,document);